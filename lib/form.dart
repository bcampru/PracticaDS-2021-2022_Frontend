                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    if (_Name == "") {
                      ...
                      if (_longtags == 0) {
                        if (_project == true) {
                          createProject(_Name, 0, _parentId, _tags.toString());
                        } else {
                          createTask(_Name, 0, _parentId, _tags.toString());
                        }
                      } else {
                        if (_project == true) {
                          createProject(_Name, 1, _parentId, _tags.toString());
                        } else {
                          createTask(_Name, 1, _parentId, _tags.toString());
                        }
                      }
